...
\hline
Region & Tx & HasGeneID & CDS & 5UTR & 3UTR \\
\hline
exon & yes & yes & yes & NA & NA \\
intron & yes & yes & no & NA & NA \\
5UTR & yes & yes & no & yes & no \\
3UTR & yes & yes & no & no & yes \\
intergenic & yes & no & NA & NA & NA\\
ncRNA & yes & no & no & NA & NA \\
\hline
\end{tabular}
\end{center}
...
McLaren W, Pritchard B, RiosD, et. al., (2010), Deriving the consequences of
...
@
\end{minipage}
\caption{\label{table:sessionInfo}
